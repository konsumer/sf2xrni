...
namespace Commons.Music.Xrni2Sf2
{
	...
	public class Driver
	{
		public static int Main (string [] args)
		{
			...
			foreach (var file in files) {
				...
				var sf2xrni = new Xrni2Sf2StreamingConverter (path);
	...
	public class Xrni2Sf2StreamingConverter : Xrni2Sf2
	{
		string xrni_dir;
		int count;

		public Xrni2Sf2StreamingConverter (string xrniDir)
		{
			xrni_dir = xrniDir;
		}
